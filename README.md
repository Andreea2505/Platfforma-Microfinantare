...
Unui contract se creeaza pentru un singur proiect.
Unui proiect ii corespunde un sigur contract.
...
Nu pot exista două înregistrări identice în PROIECT_DOMENIU
Nu pot exista investiții fără contract
